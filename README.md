...
저는 자동차 같은 세상을 움직이는 기술의 발전이 세상을 좋은 방향으로 바꾸어 줄 것이라고 생각합니다. 아는 제 공부의 원동력입니다.

저는 가능하다면 연구자의 길도 걸어보고 싶습니다. 연구하고 싶은 분야는 **SLAM, Sensor Fusion, Reinforcement Training**입니다.

저는 제가 만든 게임을 누군가가 재미있게 해준다면 정말 행복하겠다는 생각을 가지며 게임 개발 공부를 해보고 있습니다.
